...
![Alternative credit Rating and Credit rating explanation](images/credit_rating_flow.jpg)
...
![Credit Product recommendation and personalization](images/recommendation_flow.jpg)
...
> **Note:** The images above are located in the `images/` directory. If not present, please add the images as `recommendation_flow.png` and `credit_rating_flow.png` for correct rendering.
...
- **mongo**: MongoDB Atlas using the connection string
