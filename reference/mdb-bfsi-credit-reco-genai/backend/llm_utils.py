...
from fireworks_util import FireworksWithTrace
...
model_mistral_8x22b="accounts/fireworks/models/mixtral-8x22b-instruct"
model_llama_3_1_405B = "accounts/fireworks/models/llama-v3p1-405b-instruct"

llm = FireworksWithTrace(
