...
1. **UI Service**: Streamlit-based web interface for user interaction (Port 8505)
...
3. Deploy on AWS
   ...
   ./one-click.ksh
   ```
4. Access the application at locally: `http://localhost:8505` or aws: `http://<ec2-instance-ip>:8505`

### Post-Deployment Verification
1. Access the UI service by navigating to `http://<ec2-instance-ip>:8505` in your web browser.
...
The MAAP UI is accessible via a web browser at `http://[server-ip]:8505`. The interface includes:
