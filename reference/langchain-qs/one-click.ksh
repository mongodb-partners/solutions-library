...
# Variables
INFRA_STACK_NAME="MAAP-Langchain-Stack-Infrastructure"
EC2_STACK_NAME="MAAP-Langchain-Stack-Compute"
...
ServerInstanceProfile="MAAPLangchainServerInstanceProfile"

VolumeSize=100 #Disk Storage Space

GIT_REPO_URL="https://github.com/mongodb-partners/maap-langchain-qs.git"

TAG_NAME="MAAP-Langchain-One-Click"

MongoDBClusterName="MongoDBLangchainV1"
MongoDBUserName="*******"
MongoDBPassword="*******"
APIPUBLICKEY="*******"
APIPRIVATEKEY="*******"
...
{
  # Parameters
  KEY_NAME="MAAPLangchainKeyV1"  # You can change the key pair name as desired
